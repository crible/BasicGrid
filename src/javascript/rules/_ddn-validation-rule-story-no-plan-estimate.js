Ext.define('DDN.validation.StoryNoPlanEstimateRule',{
    extend: 'DDN.validation.BaseRule',
    alias:  'widget.ddnstorynoplanestimaterule',
    ...
    getFilters: function() {        
        ...
        return Rally.data.wsapi.Filter.and([
            {property:'PlanEstimate',operator:'=',value:5},
